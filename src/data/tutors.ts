...
export const TUTORS: Tutor[] = [
  {
    ...
    bio: "Добрый и внимательный преподаватель — никогда не скучно. Объясняю так, что всё само укладывается в голове. Математика, физика и химия — три любимых предмета, и эту любовь умею передать.",
    color: PINK,
  ...
  },
  {
    ...
    bio: "Дистанционный формат, последовательный разбор всех нужных тем с большим упором на практику — задачи, а не просто теория. Терпеливость и тактичность — главные качества. Готов отвечать на вопросы между занятиями.",
    color: YELLOW,
    telegram: "valeruj04",
  },
  {
  ...
  },
  {
    ...
    bio: "Репетитор со стажем. Добрый и внимательный преподаватель — объяснение разговором, вдумчиво, мягко. Комфортная атмосфера, где можно задавать любые вопросы без стеснения. Математика и физика — в удовольствие.",
    color: PEACH,
    telegram: "Liusinija",
  },
  {
  ...
  },
  {
    ...
    bio: "Математика, физика, химия — школа и вуз. Квантовая химия — отдельная специализация. Объяснение разговором, вдумчиво и честно, без лишней воды. Фокус на глубоком понимании, а не зубрёжке.",
    color: YELLOW,
    telegram: "beybars_r",
  },
  {
